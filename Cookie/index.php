...
<body onload="loopTime();">

    <button type="button" onclick="deleteAllCookies()">Del All Cookies</button>
    <?php
            echo "<br>";
            echo "<br>";
            echo '<script> document.write(checkCookie("Page", window.location.href)); </script>';
            ...
            echo '<script> document.write(getCookie("City")); </script>';
            echo '<br>';
            echo '<script> document.write(getCookie("Country")); </script>';
            ?>
